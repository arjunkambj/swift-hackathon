    ...
    >
      <Sidebar>
        ...
        <SidebarContent className="px-3">
          <SidebarGroup>
            <SidebarGroupLabel className="text-base font-medium uppercase tracking-wide px-3 mb-2">
              Token
            </SidebarGroupLabel>
            <SidebarGroupContent className="space-y-1">
              {menuItems.map((item) => (
                <SidebarMenu key={item.href}>
                  <SidebarMenuButton
                    ...
                    className={`font-medium w-full justify-start rounded-md transition-colors py-2.5 text-base ${
                      isActive(item.href)
              ...
              <SidebarMenu>
                <SidebarMenuButton
                  className={`font-medium w-full justify-start rounded-md text-muted-foreground transition-colors py-2.5 text-base`}
                >
        ...
        <SidebarFooter className="p-4 border-t">
          <SidebarMenu className="flex flex-col gap-2 mb-4">
            <SidebarMenuButton className="text-sm font-medium w-full justify-start rounded-md transition-colors">
            ...
            <div className="flex gap-2">
              <Link href="https://x.com/caffeinator_bot" target="_blank">
                <Button
                  variant="outline"
                  size="icon"
                  className="h-9 w-9 rounded-md hover:cursor-pointer hover:bg-accent/90"
                >
                  <svg
